...
public class Network extends Thread {
    ...
    private static Semaphore BufferOutEmpty;
    private static Semaphore BufferOutFull;
    private static Semaphore BufferInEmpty;
    private static Semaphore BufferInFull;
     ...
     */
     Network( )
      { 
         ...
         BufferOutEmpty = new Semaphore(maxNbPackets);
         BufferOutFull = new Semaphore(0);
         BufferInEmpty = new Semaphore(maxNbPackets);
         BufferInFull = new Semaphore(0);
         SemaphoreIn = new Semaphore(1);
         SemaphoreOut = new Semaphore(1);
      }     
     ...
     */
        public static boolean receive(Transactions outPacket) {
        	try {
                ...
                // Release semaphores after critical section
                SemaphoreOut.release();
                BufferOutEmpty.release();
                return true;
            } 
...
//System.out.println("\n DEBUG : Network.run() - starting network thread");
		...
		/* Implement here the code for the run method ... */
            ...
            if (getClientConnectionStatus().equals("disconnected") && getServerConnectionStatus().equals("disconnected")) {
                break; // Break the loop if both are disconnected
            }
