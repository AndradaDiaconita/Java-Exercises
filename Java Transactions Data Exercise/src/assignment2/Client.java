...
public class Client extends Thread { 
     ...
     */
     public void readTransactions()
     {
        ...
        try
        {
        	...
        	inputStream = new Scanner(new FileInputStream("C:\\Users\\andra\\eclipse-workspace\\Comp346_Assignment2\\src\\assignment2/transaction2.txt"));
        }
    ...
    {   
        ...
        if (getClientOperation().equals("sending")) {
            ...
            System.out.println("Client sending time: " + (sendClientEndTime - sendClientStartTime) + " milliseconds");
